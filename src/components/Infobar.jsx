        ...
        <div className="art-info-bar-frame">
          ...
          <div className="art-header">
            ...
            <div className="art-avatar">
              ...
              >
                <img src={data.about.avatar.url} alt="avatar" />
          ...
          <div id="scrollbar2" className="art-scroll-frame" on>
            ...
            <div className="art-table p-15-15">
              ...
              <ul>
                ...
                <li>
                  <h6>Residence:</h6>
                  <span>{data.about.address.split(",")[1]}</span>
                </li>
                {/* city */}
                <li>
                  <h6>City:</h6>
                  <span>{data.about.address.split(",")[0]}</span>
                </li>
                {/* age */}
                {data.about.age && (
                  <li>
                    <h6>Age:</h6>
                    <span>{data.about.age}</span>
                  </li>
                )}
                {data.about.exp_year && (
                  <li>
                    <h6>Experience:</h6>
                    <span>{data.about.exp_year}</span>
                  </li>
                )}
              </ul>
            </div>
